...
function AdminProductPage() {
    ...
    const addProduct = () => {
        ...
        const productsRef = push(ref(database, `products/${selectedCategory}/brands/${selectedBrand}/products`));
    ...
    const updateProduct = (categoryId, brandId, productId, updatedProduct) => {
        const productRef = ref(database, `products/${categoryId}/brands/${brandId}/products/${productId}`);
                                ...
                                {Object.entries(categories).map(([categoryId, category]) => (
                                    <div key={categoryId} style={{ border: "1px solid black", padding: 20, margin: 10, textAlign: "center" }} className="category-item">
                                        {editingCategory === categoryId ? (
                                            ...
                                            <div>
                                                <h3 onClick={() => setSelectedCategory(categoryId)}>{category.name}</h3>
